...
const LOCKED_NEXT =
  '記録の閲覧・検索・カルテはこれまでどおり使えます。下のタブから「タイムライン」「カルテ」「検索」をお使いください。'

// 封鎖中は App.tsx 側の <fieldset disabled> によりこの再試行ボタンも押せなくなるため、
// 代替の回復手順（タブを移動して記録タブを開き直す＝フラグを取り直す）まで書いておく
const LOAD_ERROR =
  'アプリで入力できる期間かどうかを確認できませんでした。通信状態を確認して［再試行する］を押してください。押せない場合は、下のタブでほかの画面に移ってから「記録」をもう一度開いてください。'
